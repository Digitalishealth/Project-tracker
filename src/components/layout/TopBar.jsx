...
const IconCalendar = () => (
  <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5">
    <path d="M5.75 7.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM5 10.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0Zm5.75-3.25a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM10 10.75a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0ZM8 7.5a.75.75 0 1 0 0 1.5A.75.75 0 0 0 8 7.5Zm-.75 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0Z" />
...
const IconUpload = () => (
  <svg viewBox="0 0 16 16" fill="currentColor" className="w-3.5 h-3.5">
    ...
    <path d="M3.5 6.25a.75.75 0 0 1-1.5 0v-1.5A2.75 2.75 0 0 1 4.75 2h6.5A2.75 2.75 0 0 1 14 4.75v1.5a.75.75 0 0 1-1.5 0v-1.5c0-.69-.56-1.25-1.25-1.25h-6.5c-.69 0-1.25-.56-1.25 1.25v1.5Z" />
  </svg>
)
      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-1 bg-slate-50 border border-slate-200 rounded-lg p-1">
          <button onClick={handleExportICS} title="Export calendar (.ics)"
            className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-slate-500 hover:text-slate-800 hover:bg-white rounded-md transition-all font-medium">
        ...
        <button onClick={onAdd}
          className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-indigo-600 text-white rounded-lg hover:bg-indigo-500 active:bg-indigo-700 transition-colors shadow-sm">
